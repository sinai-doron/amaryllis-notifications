(function (global, factory) {
	...
	(factory((global.AmaryllisNotifications = {}),global.React,global.Redux));
	...
	*/
...

	{
	  ...
	  warning = function warning(condition, format) {
	    ...
	    if (!condition) {
	      ...
	      printWarning$2.apply(undefined$h, [format].concat(args));
	    }
	  };
	}
	...
	function getActiveElement(doc) /*?DOMElement*/{
	  doc = doc || (typeof document !== 'undefined' ? document : undefined$j);
	...
	!React$$1 ? invariant(false, 'ReactDOM was loaded before React. Make sure you load the React package before loading ReactDOM.') : void 0;
	...
	function executeDispatch(event, simulated, listener, inst) {
	  ...
	  ReactErrorUtils.invokeGuardedCallbackAndCatchFirstError(type, listener, undefined$H, event);
	...
	function getData() {
	  ...
	  var sliceTail = end > 1 ? 1 - end : undefined$H;
	...
	function getValueForAttribute(node, name, expected) {
	  {
	    ...
	    if (!node.hasAttribute(name)) {
	      return expected === undefined$H ? undefined$H : null;
	    }
	...
	function getHostProps(element, props) {
	  ...
	  var hostProps = _assign({}, props, {
	    defaultChecked: undefined$H,
	    defaultValue: undefined$H,
	    value: undefined$H,
	...
	function initWrapperState(element, props) {
	  {
	    ...
	    if (props.checked !== undefined$H && props.defaultChecked !== undefined$H && !didWarnCheckedDefaultChecked) {
	      warning(false, '%s contains an input of type %s with both checked and defaultChecked props. ' + 'Input elements must be either controlled or uncontrolled ' + '(specify either the checked prop, or the defaultChecked prop, but not ' + 'both). Decide between using a controlled or uncontrolled input ' + 'element and remove one of these props. More info: ' + 'https://fb.me/react-controlled-components', getCurrentFiberOwnerName() || 'A component', props.type);
	      didWarnCheckedDefaultChecked = true;
	    }
	    if (props.value !== undefined$H && props.defaultValue !== undefined$H && !didWarnValueDefaultValue) {
	...
	function has(key) {
	  return key._reactInternalFiber !== undefined$H;
	}
	...
	var SimpleEventPlugin = {
	  ...
	  isInteractiveTopLevelEventType: function (topLevelType) {
	    ...
	    return config !== undefined$H && config.isInteractive === true;
	  },
	...
	function setOffsets(node, offsets) {
	  ...
	  var end = offsets.end === undefined$H ? start : Math.min(offsets.end, length);
	...
	var localRequestAnimationFrame$1 = typeof requestAnimationFrame === 'function' ? requestAnimationFrame : undefined$H;
	...
	function getHostProps$1(element, props) {
	  var hostProps = _assign({ children: undefined$H }, props);
	...
	function initWrapperState$1(element, props) {
	  ...
	  {
	    if (props.value !== undefined$H && props.defaultValue !== undefined$H && !didWarnValueDefaultValue$1) {
	...
	function postUpdateWrapper(element, props) {
	  ...
	  // this value down
	  node._wrapperState.initialValue = undefined$H;
	...
	function initWrapperState$2(element, props) {
	  var node = element;
	  {
	    ...
	    if (props.value !== undefined$H && props.defaultValue !== undefined$H && !didWarnValDefaultVal) {
...

	{
	  ...
	  validateProperty$1 = function (tagName, name, value, canUseEventSystem) {
	    ...
	    if (lowerCasedName === 'is' && value !== null && value !== undefined$H && typeof value !== 'string') {
	...
	function diffProperties$1(domElement, tag, lastRawProps, nextRawProps, rootContainerElement) {
	  ...
	  for (propKey in nextProps) {
	    var nextProp = nextProps[propKey];
	    var lastProp = lastProps != null ? lastProps[propKey] : undefined$H;
	    ...
	    if (propKey === STYLE) {
	      ...
	      var nextHtml = nextProp ? nextProp[HTML] : undefined$H;
	      var lastHtml = lastProp ? lastProp[HTML] : undefined$H;
	      if (nextHtml != null) {
	...
	function diffHydratedProperties$1(domElement, tag, rawProps, parentNamespace, rootContainerElement) {
	  ...
	  for (var propKey in rawProps) {
	    ...
	    if (registrationNameModules.hasOwnProperty(propKey)) {
	      ...
	      if (suppressHydrationWarning) ; else if (isCustomComponentTag) {
	    ...
	    default:
	      {
	        var info = '';
	        {
	          if (type === undefined$H || typeof type === 'object' && type !== null && Object.keys(type).length === 0) {
...

	{
	  ...
	  lowPriorityWarning = function (condition, format) {
	    ...
	    if (!condition) {
	      ...
	      printWarning.apply(undefined$H, [format].concat(args));
	    }
	  };
	}
...

	{
	  ...
	  ReactStrictModeWarnings.recordLegacyContextWarning = function (fiber, instance) {
	    ...
	    if (fiber.type.contextTypes != null || fiber.type.childContextTypes != null || instance !== null && typeof instance.getChildContext === 'function') {
	      if (warningsForRoot === undefined$H) {
	        warningsForRoot = [];
	    ...
	    case UpdateState:
	      {
	        ...
	        if (partialState === null || partialState === undefined$H) {
	...
	function pushProvider(providerFiber) {
...

	  {
	    ...
	    {
	      !(context._currentRenderer === undefined$H || context._currentRenderer === null || context._currentRenderer === rendererSigil) ? warning(false, 'Detected multiple renderers concurrently rendering the ' + 'same context provider. This is currently unsupported.') : void 0;
	...
	function applyDerivedStateFromProps(workInProgress, getDerivedStateFromProps, nextProps) {
	  ...
	  // Merge the partial state and the previous state.
	  var memoizedState = partialState === null || partialState === undefined$H ? prevState : _assign({}, prevState, partialState);
	...
	var classComponentUpdater = {
	  ...
	  enqueueSetState: function (inst, payload, callback) {
	    ...
	    if (callback !== undefined$H && callback !== null) {
	      {
	...
	function checkShouldComponentUpdate(workInProgress, oldProps, newProps, oldState, newState, newContext) {
	  ...
	  if (typeof instance.shouldComponentUpdate === 'function') {
	    ...
	    {
	      !(shouldUpdate !== undefined$H) ? warning(false, '%s.shouldComponentUpdate(): Returned undefined instead of a ' + 'boolean value. Make sure to return true or false.', getComponentName(workInProgress) || 'Component') : void 0;
	    }
	...
	function checkClassInstance(workInProgress) {
	  ...
	  var type = workInProgress.type;
	  {
	    ...
	    !(instance.props === undefined$H || !hasMutatedProps) ? warning(false, '%s(...): When calling super() in `%s`, make sure to pass ' + "up the same props that your component's constructor was passed.", name, name) : void 0;
	...
	function constructClassInstance(workInProgress, props, renderExpirationTime) {
	  ...
	  var state = workInProgress.memoizedState = instance.state !== null && instance.state !== undefined$H ? instance.state : null;
	...
	function mountIndeterminateComponent(current, workInProgress, renderExpirationTime) {
	  ...
	  if (typeof value === 'object' && value !== null && typeof value.render === 'function' && value.$$typeof === undefined$H) {
	    var Component = workInProgress.type;

	    // Proceed under the assumption that this is a class instance
	    workInProgress.tag = ClassComponent;

	    workInProgress.memoizedState = value.state !== null && value.state !== undefined$H ? value.state : null;
	...
	function updateContextConsumer(current, workInProgress, renderExpirationTime) {
	  ...
	  if (observedBits === undefined$H || observedBits === null) {
	        ...
	        if (finishedWork.effectTag & Snapshot) {
	          if (current !== null) {
	            ...
	            var snapshot = instance.getSnapshotBeforeUpdate(prevProps, prevState);
	            {
	              ...
	              if (snapshot === undefined$H && !didWarnSet.has(finishedWork.type)) {
	...
	function scheduleRootUpdate(current, element, expirationTime, callback) {
	  ...
	  callback = callback === undefined$H ? null : callback;
	  if (callback !== null) {
	...
	implementation) {
	  var key = arguments.length > 3 && arguments[3] !== undefined$H ? arguments[3] : null;
	...
	function createPortal(children, container) {
	  var key = arguments.length > 2 && arguments[2] !== undefined$H ? arguments[2] : null;
	...
	var ReactDOM = {
	  ...
	  unstable_createPortal: function () {
	    ...
	    return createPortal.apply(undefined$H, arguments);
	  },
	...
	exports.classNamesShape = exports.timeoutsShape = undefined$L;
	...
	exports.__esModule = true;
	exports.EXITING = exports.ENTERED = exports.ENTERING = exports.EXITED = exports.UNMOUNTED = undefined$O;
	...
	var Transition = function (_React$Component) {
	  ...
	  Transition.prototype.updateStatus = function updateStatus() {
	    var mounting = arguments.length > 0 && arguments[0] !== undefined$O ? arguments[0] : false;
	...
	Transition.propTypes = {
	  ...
	  timeout: function timeout(props) {
	    ...
	    return pt.apply(undefined$O, [props].concat(args));
	  },
	...
	var TransitionGroup = function (_React$Component) {
	  ...
	  TransitionGroup.prototype.getProp = function getProp(child, prop) {
	    var props = arguments.length > 2 && arguments[2] !== undefined$V ? arguments[2] : this.props;
	...
	function createProvider() {
	  ...
	  var storeKey = arguments.length > 0 && arguments[0] !== undefined$12 ? arguments[0] : 'store';
	...
	*/
	selectorFactory) {
	  ...
	  var _ref = arguments.length > 1 && arguments[1] !== undefined$16 ? arguments[1] : {},
	      _ref$getDisplayName = _ref.getDisplayName,
	      getDisplayName = _ref$getDisplayName === undefined$16 ? function (name) {
	    return 'ConnectAdvanced(' + name + ')';
	  } : _ref$getDisplayName,
	      _ref$methodName = _ref.methodName,
	      methodName = _ref$methodName === undefined$16 ? 'connectAdvanced' : _ref$methodName,
	      _ref$renderCountProp = _ref.renderCountProp,
	      renderCountProp = _ref$renderCountProp === undefined$16 ? undefined$16 : _ref$renderCountProp,
	      _ref$shouldHandleStat = _ref.shouldHandleStateChanges,
	      shouldHandleStateChanges = _ref$shouldHandleStat === undefined$16 ? true : _ref$shouldHandleStat,
	      _ref$storeKey = _ref.storeKey,
	      storeKey = _ref$storeKey === undefined$16 ? 'store' : _ref$storeKey,
	      _ref$withRef = _ref.withRef,
	      withRef = _ref$withRef === undefined$16 ? false : _ref$withRef,
	  ...
	  return function wrapWithConnect(WrappedComponent) {
	    ...
	    var Connect = function (_Component) {
	      ...
	      Connect.prototype.notifyNestedSubsOnComponentDidUpdate = function notifyNestedSubsOnComponentDidUpdate() {
	        ...
	        // in some perf boost.
	        this.componentDidUpdate = undefined$16;
	        this.notifyNestedSubs();
	      };
	...
	/** Built-in value references. */
	var symToStringTag = Symbol$1 ? Symbol$1.toStringTag : undefined$1b;
	...
	function getRawTag(value) {
	  ...
	  try {
	    value[symToStringTag] = undefined$1b;
	  } catch (e) {}
	...
	/** Built-in value references. */
	var symToStringTag$1 = Symbol$1 ? Symbol$1.toStringTag : undefined$1d;
	...
	function baseGetTag(value) {
	  if (value == null) {
	    return value === undefined$1d ? undefinedTag : nullTag;
	  }
	...
	function getDependsOnOwnProps(mapToProps) {
	  return mapToProps.dependsOnOwnProps !== null && mapToProps.dependsOnOwnProps !== undefined$1j ? Boolean(mapToProps.dependsOnOwnProps) : mapToProps.length !== 1;
	}
	...
	function whenMapDispatchToPropsIsFunction(mapDispatchToProps) {
	  return typeof mapDispatchToProps === 'function' ? wrapMapToPropsFunc(mapDispatchToProps, 'mapDispatchToProps') : undefined$1k;
	}
	...
	function whenMapStateToPropsIsFunction(mapStateToProps) {
	  return typeof mapStateToProps === 'function' ? wrapMapToPropsFunc(mapStateToProps, 'mapStateToProps') : undefined$1l;
	}
	...
	function whenMergePropsIsFunction(mergeProps) {
	  return typeof mergeProps === 'function' ? wrapMergePropsFunc(mergeProps) : undefined$1m;
	}
	...
	function createConnect() {
	  var _ref = arguments.length > 0 && arguments[0] !== undefined$1p ? arguments[0] : {},
	      _ref$connectHOC = _ref.connectHOC,
	      connectHOC = _ref$connectHOC === undefined$1p ? connectAdvanced : _ref$connectHOC,
	      _ref$mapStateToPropsF = _ref.mapStateToPropsFactories,
	      mapStateToPropsFactories = _ref$mapStateToPropsF === undefined$1p ? defaultMapStateToPropsFactories : _ref$mapStateToPropsF,
	      _ref$mapDispatchToPro = _ref.mapDispatchToPropsFactories,
	      mapDispatchToPropsFactories = _ref$mapDispatchToPro === undefined$1p ? defaultMapDispatchToPropsFactories : _ref$mapDispatchToPro,
	      _ref$mergePropsFactor = _ref.mergePropsFactories,
	      mergePropsFactories = _ref$mergePropsFactor === undefined$1p ? defaultMergePropsFactories : _ref$mergePropsFactor,
	      _ref$selectorFactory = _ref.selectorFactory,
	      selectorFactory = _ref$selectorFactory === undefined$1p ? finalPropsSelectorFactory : _ref$selectorFactory;

	  return function connect(mapStateToProps, mapDispatchToProps, mergeProps) {
	    var _ref2 = arguments.length > 3 && arguments[3] !== undefined$1p ? arguments[3] : {},
	        _ref2$pure = _ref2.pure,
	        pure = _ref2$pure === undefined$1p ? true : _ref2$pure,
	        _ref2$areStatesEqual = _ref2.areStatesEqual,
	        areStatesEqual = _ref2$areStatesEqual === undefined$1p ? strictEqual : _ref2$areStatesEqual,
	        _ref2$areOwnPropsEqua = _ref2.areOwnPropsEqual,
	        areOwnPropsEqual = _ref2$areOwnPropsEqua === undefined$1p ? shallowEqual$1 : _ref2$areOwnPropsEqua,
	        _ref2$areStatePropsEq = _ref2.areStatePropsEqual,
	        areStatePropsEqual = _ref2$areStatePropsEq === undefined$1p ? shallowEqual$1 : _ref2$areStatePropsEq,
	        _ref2$areMergedPropsE = _ref2.areMergedPropsEqual,
	        areMergedPropsEqual = _ref2$areMergedPropsE === undefined$1p ? shallowEqual$1 : _ref2$areMergedPropsE,
	...
	const reducers = function (state = { notifications: [] }, action) {
	    switch (action.type) {
	        case C.SHOW_NOTIFICATION:
	            return _extends$3({}, state, { notifications: state.notifications.concat(action.payload) });
	        case C.DISMISS_NOTIFICATION:
	            return _extends$3({}, state, { notifications: state.notifications.filter(notification => notification.id !== action.payload.id) });
	        case C.DISMISS_ALL_NOTIFICATION:
	            return _extends$3({}, state, { notifications: [] });
	        default:
	            return state;
	    }
	};
	...
	class Notification extends React__default.Component {
	    ...
	    renderIcon(icon, styles) {
	        if (icon) {
	            ...
	            return React__default.createElement('span', { className: classNames, style: styles });
	        }
	        return null;
	    }
	    ...
	    render() {
	        const props = _extends$3({}, this.props, { dismissnotification: "" });
	        const options = _extends$3({}, props.options);
	        let classNames = ['amaryllis-notification'];
	        let styles = _extends$3({}, options.styles);
	...
	var Notification$1 = connect(null, mapActionsToProps)(Notification);

	const mapStateToProps = state => ({
	    notifications: state.notifications
	});

	class Notifications extends React__default.Component {

	    render() {
	        const props = _extends$3({}, this.props);
	        const { notifications } = this.props.notifications;

	        const notificationsItems = notifications.map(item => React__default.createElement(Notification$1, {
	            key: item.id,
	...
	var Notifications$1 = connect(mapStateToProps)(Notifications);

	const AMARYLLIS_TYPES = {
	    INFO: 'info',
	    WARNING: 'warning',
	    ERROR: 'error',
	    SUCCESS: 'success',
	...
	exports.NotificationsActions = actions;
	exports.NotificationsReducers = reducers;
	exports.NotificationsConstants = C;
	exports.AMARYLLIS_TYPES = AMARYLLIS_TYPES;
